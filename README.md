...
```kotlin
plugins {
    kotlin("jvm") version "1.9.10" // Currently the plugin is only available for Kotlin-JVM
    id("io.exoquery.terpal-plugin") version "1.9.10-0.2.0"
    kotlin("plugin.serialization") version "1.9.10"
}

dependencies {
    api("io.exoquery:terpal-sql-jdbc:1.9.10-0.2.0")
