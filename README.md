...
// The advantage of this approach is that you can insert and select the Person-class directly.
...
val values: List<JsonExample> = Sql("SELECT person FROM JsonExample").queryOf<Person>().runOn(ctx)
```
