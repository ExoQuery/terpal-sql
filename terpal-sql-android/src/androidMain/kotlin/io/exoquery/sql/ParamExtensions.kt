...
@OptIn(SerApi::class) fun Param.Companion.fromSqlDate(value: Date?): Param<Date> = Param(ContextualSerializer(Date::class), Date::class, value)
@OptIn(SerApi::class) operator fun Param.Companion.invoke(value: Time?): Param<Time> = Param(ContextualSerializer(Time::class), Time::class, value)
@OptIn(SerApi::class) operator fun Param.Companion.invoke(value: Timestamp?): Param<Timestamp> = Param(ContextualSerializer(Timestamp::class), Timestamp::class, value)
